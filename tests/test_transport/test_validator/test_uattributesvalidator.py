...
from uprotocol.proto.uprotocol.v1.uattributes_pb2 import UAttributes, UMessageType, UPriority
...
class TestUAttributesValidator(unittest.TestCase):
    ...
    def test_uattributes_validator_response_with_request_attributes(self):
        request = UMessageBuilder.request(build_default_uuri(), build_method_uuri(), 1000).build()
        message = UMessageBuilder.response(request.attributes).build()
    ...
    def test_uattributes_validator_response_with_request_validator(self):
        request = UMessageBuilder.request(build_default_uuri(), build_method_uuri(), 1000).build()
        response = UMessageBuilder.response(request.attributes).build()
    ...
    def test_uattribute_validator_request_valid_permission_level(self):
        message = UMessageBuilder.request(build_default_uuri(), build_method_uuri(), 1000).with_permission_level(1).build()
