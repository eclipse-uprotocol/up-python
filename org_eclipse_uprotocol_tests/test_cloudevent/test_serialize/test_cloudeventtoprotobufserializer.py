...
from org_eclipse_uprotocol.cloudevent.serialize.cloudeventtoprotobufserializer import CloudEventToProtobufSerializer
...
def get_json_object():
    ...
    json_file_path = os.path.join(current_directory, "org_eclipse_uprotocol_tests","test_cloudevent",
