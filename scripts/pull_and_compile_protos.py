    ...
    for root, dirs, files in os.walk(directory):
        ...
        for file in files:
            if file.endswith('.py'):
                ...
                replace_in_file(file_path, r"from uprotocol.v1 import ", "import uprotocol.proto.uprotocol.v1.")
                replace_in_file(file_path, r"from uprotocol import ", "import uprotocol.proto.uprotocol.")
                replace_in_file(file_path, r"import uoptions_pb2", "import uprotocol.proto.uprotocol.uoptions_pb2")
